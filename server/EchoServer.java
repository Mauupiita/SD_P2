...
public class EchoServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(myURL + ": no puedo escuchar en el puerto: 8008, " +e.toString());
            System.exit(1);
        }
        System.out.println(myURL + ": EchoServer esta escuchando en el  puerto: 8008");
        ...
        try {
            ...
            while(listening) // bucle infinito
            {
                ...
                //{
                    ...
                    tarjeta = is.readLine();
                    cvv = is.readLine();
                    //ver = String.valueOf(eo.pago(inputline,tarjeta,cvv));
                    System.out.println(String.valueOf(eo.pago(inputline,tarjeta,cvv)));
                    os.println(String.valueOf(eo.pago(inputline,tarjeta,cvv)));//escribimos en el socket lo recibido mas mensaje
